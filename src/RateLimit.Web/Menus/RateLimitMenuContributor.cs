...
namespace RateLimit.Web.Menus;

public class RateLimitMenuContributor : IMenuContributor
{
    private readonly IConfiguration _configuration;

    public RateLimitMenuContributor(IConfiguration configuration)
    {
    ...
    private Task ConfigureMainMenuAsync(MenuConfigurationContext context)
    {
        ...
        var l = context.GetLocalizer<RateLimitResource>();
